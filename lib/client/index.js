...
Client.prototype.subscribe = function(service, alias, meta_target) {
  this.socket.emit('subscribe on service', this.service, service, alias, meta_target);
};

Client.prototype.registerServiceSubscribed = function(service, alias, meta_target) {
  this.servicesSubscribed[alias || service.name] = service;
  this.servicesSubscribed[alias || service.name].meta_target = meta_target;
};
...
Client.prototype.get = function(nameService) {
  ...
  return function(action, callback) {
    ...
    var prefix = (service.meta_target ? service.meta[service.meta_target] : '');
